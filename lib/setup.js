...
let mavenCleanAndAutoInstall = (commandSeparator, folderSeparator) => {
    ...
    let runMavenCleanInstall = (operatingSystem === 'win32' && !process.env.JAVA_HOME) ? '$env:JAVA_HOME = [Environment]::GetEnvironmentVariable(\'JAVA_HOME\', \'Machine\')' + commandSeparator : '';
